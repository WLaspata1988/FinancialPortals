...
namespace FinancialPortals.Controllers
{
    public class BudgetCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,Name,Target,Actual,Created,Updated")] BudgetCategory budgetCategory)
        {
            ...
            ViewBag.HouseholdId = new SelectList(db.Households, "Id", "OwnerId", budgetCategory.HouseholdId);
            return View(budgetCategory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,Name,Target,Actual,Created,Updated")] BudgetCategory budgetCategory)
        {
            if (ModelState.IsValid)
            {
