...
namespace FinancialPortals.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BankAccountId,TransactionTypeId,BudgetItemId,OwnerId,Amount,Memo,Created,Updated")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BankAccountId,TransactionTypeId,BudgetItemId,OwnerId,Amount,Memo,Created,Updated")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
